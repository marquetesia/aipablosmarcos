          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              ...
              <div className="card p-8">
                <div className="w-16 h-16 mx-auto mb-6 rounded-lg bg-black text-white flex items-center justify-center">
              ...
              {/* GoHighLevel */}
              <div className="card p-8">
                <div className="w-16 h-16 mx-auto mb-6 rounded-lg bg-blue-600 text-white flex items-center justify-center">
              ...
              {/* n8n */}
              <div className="card p-8">
                <div className="w-16 h-16 mx-auto mb-6 rounded-lg bg-notion-yellow text-yellow-800 flex items-center justify-center">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center card p-12 max-w-4xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Agenda una llamada gratuita y descubre cómo la IA puede revolucionar tu empresa
              </p>
              <Button
                size="lg"
